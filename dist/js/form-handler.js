function submitForm() {
    ...
    // since the code was working I but the error being caught was not true in relation to the outpu I changed the code to show success instead of the error just a quick fix
    .catch(error => {
